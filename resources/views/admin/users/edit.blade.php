...
<div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <h1 class="text-3xl font-bold mb-8 text-gray-900 dark:text-white">Edit Siswa</h1>

    <form action="{{ route('admin.users.update', $user->id) }}" method="POST" class="glass rounded-lg p-6">
        @csrf
        @method('PUT')
        ...
        <div class="mb-4">
            <label for="password" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Password (biarkan kosong jika tidak ingin diubah)</label>
